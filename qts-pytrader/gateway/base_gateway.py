...
from core.event.event_mgr import Event, EventEngine
...
class BaseGateway(ABC):
    ...
    * on_contract
    ...
    def on_tick(self, tick: TickData) -> None:
        ...
        self.on_event(EVENT_TICK + tick.std_symbol, tick)
    ...
    def on_trade(self, trade: TradeData) -> None:
        ...
        self.on_event(EVENT_TRADE + trade.std_symbol, trade)
    ...
    def on_order(self, order: OrderData) -> None:
        ...
        self.on_event(EVENT_ORDER + order.orderid, order)
    ...
    def on_position(self, position: PositionData) -> None:
        ...
        self.on_event(EVENT_POSITION + position.std_symbol, position)
    ...
    def on_quote(self, quote: QuoteData) -> None:
        ...
        self.on_event(EVENT_QUOTE + quote.std_symbol, quote)
