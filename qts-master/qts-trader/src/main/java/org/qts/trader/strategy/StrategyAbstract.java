...
//
//	// 交易执行器
//	protected AcctExecutor tradeExecutor;
//	// 策略配置
...
//	 */
//	public StrategyAbstract(AcctExecutor tradeExecutor,StrategySetting strategySetting) {
...
//			this.tradeExecutor.subContract(x);
//
//		});
//
//	}
