...
public:
  ...
  virtual void OnRspUserLogin(CTORATstpRspUserLoginField *pRspUserLogin,
    ...
    if (pRspInfo && pRspInfo->ErrorID == 0) {
      ...
      int ret_md = m_api->SubscribeMarketData(
          Securities, sizeof(Securities) / sizeof(char *), exchange);
      if (ret_md == 0) {
      ...
      //            sizeof(Securities) / sizeof(char*), exchange); if (ret_t ==
      //            0)
      //            {
      ...
      //            sizeof(Securities) / sizeof(char*), exchange); if (ret_od ==
      //            0)
      //            {
      ...
      //
      //#if 1	// 指数行情订阅
      //            int ret_i = m_api->SubscribeIndex(Securities,
      //            sizeof(Securities) / sizeof(char*), eid); if (ret_i == 0)
      //            {
      ...
      //
      //#if 1   //新债逐笔订阅
      //            int ret_i = m_api->SubscribeXTSTick(Securities,
      //            sizeof(Securities) / sizeof(char*), TORA_TSTP_EXD_SSE); if
      //            (ret_i == 0)
      //            {
  ...
  //    // 订阅逐笔成交行情应答
  //    virtual void OnRspSubTransaction(CTORATstpSpecificSecurityField*
  //    pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool
  //    bIsLast)
  //    {
  //        if (pRspInfo && pRspInfo->ErrorID == 0 && pSpecificSecurity)
  //        {
  //            printf("OnRspSubTransaction SecurityID[%s] ExchangeID[%c]
  ...
  //
  //    // 订阅逐笔委托行情应答
  //    virtual void OnRspSubOrderDetail(CTORATstpSpecificSecurityField*
  //    pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool
  //    bIsLast)
  //    {
  //        if (pRspInfo && pRspInfo->ErrorID == 0 && pSpecificSecurity)
  //        {
  //            printf("OnRspSubOrderDetail SecurityID[%s] ExchangeID[%c]
  //            Success!\n", pSpecificSecurity->SecurityID,
  //            pSpecificSecurity->ExchangeID);
  //
  //        }
  //    };
  //    //订阅新债逐笔行情应答
  //    virtual void OnRspSubXTSTick(CTORATstpSpecificSecurityField*
  //    pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool
  //    bIsLast)
  //    {
  //        if (pRspInfo && pRspInfo->ErrorID == 0 && pSpecificSecurity)
  //        {
  //            printf("OnRspSubXTSTick SecurityID[%s] ExchangeID[%c]
  //            Success!\n", pSpecificSecurity->SecurityID,
  //            pSpecificSecurity->ExchangeID);
  //
  //        }
  ...
  virtual void OnRtnMarketData(CTORATstpLev2MarketDataField *pDepthMarketData,
                               const int FirstLevelBuyNum,
                               const int FirstLevelBuyOrderVolumes[],
    ...
    //        printf("OnRtnMarketData TimeStamp[%d]  SecurityID[%s]
    //        ExchangeID[%c]  PreClosePrice[%f] LowestPrice[%f] HighestPrice[%f]
    //        OpenPrice[%f] LastPrice[%f]"
    //               "BidPrice{[%f] [%f] [%f] [%f] [%f] [%f] [%f] [%f] [%f]
    //               [%f]}" "AskPrice{[%f] [%f] [%f] [%f] [%f] [%f] [%f] [%f]
    //               [%f] [%f]}" "BidVolume{[%lld] [%lld] [%lld] [%lld] [%lld]
    //               [%lld] [%lld] [%lld] [%lld] [%lld]}" "AskVolume{[%lld]
    //               [%lld] [%lld] [%lld] [%lld] [%lld] [%lld] [%lld] [%lld]
    //               [%lld]}", pDepthMarketData->DataTimeStamp,
    ...
    //               pDepthMarketData->BidPrice1, pDepthMarketData->BidPrice2,
    //               pDepthMarketData->BidPrice3, pDepthMarketData->BidPrice4,
    //               pDepthMarketData->BidPrice5, pDepthMarketData->BidPrice6,
    //               pDepthMarketData->BidPrice7, pDepthMarketData->BidPrice8,
    //               pDepthMarketData->BidPrice9, pDepthMarketData->BidPrice10,
    //               pDepthMarketData->AskPrice1, pDepthMarketData->AskPrice2,
    //               pDepthMarketData->AskPrice3, pDepthMarketData->AskPrice4,
    //               pDepthMarketData->AskPrice5, pDepthMarketData->AskPrice6,
    //               pDepthMarketData->AskPrice7, pDepthMarketData->AskPrice8,
    //               pDepthMarketData->AskPrice9, pDepthMarketData->AskPrice10,
    //               pDepthMarketData->BidVolume1, pDepthMarketData->BidVolume2,
    //               pDepthMarketData->BidVolume3, pDepthMarketData->BidVolume4,
    //               pDepthMarketData->BidVolume5, pDepthMarketData->BidVolume6,
    //               pDepthMarketData->BidVolume7, pDepthMarketData->BidVolume8,
    //               pDepthMarketData->BidVolume9,
    //               pDepthMarketData->BidVolume10,
    //               pDepthMarketData->AskVolume1, pDepthMarketData->AskVolume2,
    //               pDepthMarketData->AskVolume3, pDepthMarketData->AskVolume4,
    //               pDepthMarketData->AskVolume5, pDepthMarketData->AskVolume6,
    //               pDepthMarketData->AskVolume7, pDepthMarketData->AskVolume8,
    //               pDepthMarketData->AskVolume9, pDepthMarketData->AskVolume10
    //        );
    //
  ...
  //    // 逐笔成交通知
  //    virtual void OnRtnTransaction(CTORATstpLev2TransactionField*
  //    pTransaction)
  //    {
  //        printf("OnRtnTransaction SecurityID[%s] ",
  //        pTransaction->SecurityID); printf("ExchangeID[%c] ",
  ...
  //        printf("ExecType[%c] ",
  //        pTransaction->ExecType);//上海逐笔成交没有这个字段，只有深圳有。值2表示撤单成交，BuyNo和SellNo只有一个是非0值，以该非0序号去查找到的逐笔委托即为被撤单的委托。
  ...
  //
  //    // 订阅逐笔委托行情通知
  //    virtual void OnRtnOrderDetail(CTORATstpLev2OrderDetailField*
  //    pOrderDetail)
  //    {
  //
  //        printf("OnRtnOrderDetail SecurityID[%s] ",
  //        pOrderDetail->SecurityID); printf("ExchangeID[%d] ",
  //        pOrderDetail->ExchangeID); printf("OrderTime[%d] ",
  //        pOrderDetail->OrderTime); printf("Price[%.4f] ",
  //        pOrderDetail->Price); printf("Volume[%lld] ", pOrderDetail->Volume);
  ...
  //
  //    // 订阅指数行情应答
  //    virtual void OnRspSubIndex(CTORATstpSpecificSecurityField*
  //    pSpecificSecurity, CTORATstpRspInfoField* pRspInfo, int nRequestID, bool
  //    bIsLast)
  //    {
  //        if (pRspInfo && pRspInfo->ErrorID == 0 && pSpecificSecurity)
  ...
  int connect() override {
    ...
    // 创建接口对象
    // CTORATstpLev2MdApi* demo_md_api =
    // CTORATstpLev2MdApi::CreateTstpLev2MdApi();//TCP方式 CTORATstpLev2MdApi
    // *demo_md_api =
    // CTORATstpLev2MdApi::CreateTstpLev2MdApi(TORA_TSTP_MST_MCAST);//组播方式、UDP方式
