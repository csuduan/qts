...
from .common import HEARTBEAT_TOLERANCE, MsgType, RpcHandler, MsgHandler
...
class RpcClient:
    ...
    def req(self, msg_type: MsgType, data=None, timeout=3000) -> Any:
        if data is None:
            data = {}
        if data is None:
            data = {}
    ...
    def run(self) -> None:
        ...
        while self._active:
            ...
            if topic == MsgType.HEARTBEAT_TOPIC:
